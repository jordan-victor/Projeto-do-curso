...
function concluir(){
    ...
    if (pix != "" && dinheiro != "" && cartao != ""){
        ...
        let link = `https://wa.me/5592991774962?text=*PRODUTO:* ${qtdTr1}${ nomeTr1} ${qtdTr2}${ nomeTr2} ${qtdTr3}${ nomeTr3} ${qtdTr4}${ nomeTr4} ${qtdAt1}${ nomeAt1} ${qtdAt2}${ nomeAt2} ${qtdAt3}${ nomeAt3}  ${qtdDc1}${ nomeDc1} ${qtdDc2}${ nomeDc2} ${qtdDc3}${ nomeDc3} ${qtdCb1}${ nomeCb1} ${qtdCb2}${ nomeCb2} ${qtdCb3}${ nomeCb3} | *TOTAL:* ${ precoBurger} | *LOCALIZAÇÃO:* Bairro ${bair}, Rua ${ru} e casa ${cas} | *OBS:* ${ obs}`
        enviarZap.href = link
